...
class RequestSecondOpinion extends StatefulWidget {
  const RequestSecondOpinion({Key? key}) : super(key: key);

  @override
  State<RequestSecondOpinion> createState() => _RequestSecondOpinionState();
}

class _RequestSecondOpinionState extends State<RequestSecondOpinion> {
  TimeOfDay? startTime;
  TimeOfDay? endTime;
