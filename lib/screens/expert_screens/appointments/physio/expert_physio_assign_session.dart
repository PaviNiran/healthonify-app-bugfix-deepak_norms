...
class ExpertPhysioAssignSession extends StatelessWidget {
  final String? subId;
  const ExpertPhysioAssignSession({Key? key, required this.subId})
      : super(key: key);
...
class _AssignSessionFormState extends State<AssignSessionForm> {
  ...
  _onSubmit() {
    ...
    reqData["startDate"] = DateFormat("M/d/y").format(_selectedDate!);
