...
import 'package:healthonify_mobile/widgets/wm/viewdietplan/view_meal_plan_widget.dart';

enum Menu { itemOne, itemTwo, itemThree, itemFour }

class ViewDietDietPlan extends StatefulWidget {
  final String title;
  final List<GetMeal> mealsList;
  final Function deleteMeal;
  final bool isEdit;
  const ViewDietDietPlan({
    Key? key,
    required this.title,
  ...
  @override
  State<ViewDietDietPlan> createState() => _ViewDietDietPlanState();
}

class _ViewDietDietPlanState extends State<ViewDietDietPlan> {
  List<GetMeal> meals = [];
  ...
  void initState() {
    ...
    if (meals.isNotEmpty) calculateCalories();
  }
  ...
  void calculateCalories() {
    ...
    try {
      ...
      log("Unable to calculate calories in view diet plans");
    }
  }
